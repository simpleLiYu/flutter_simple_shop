      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          buildSvgPictureIcon("assets/svg/tupian.svg", 80,onTap:() async {
            ...
            Rect wh = await ImageUtil().getImageWH(localUrl: pickedFile.path);
